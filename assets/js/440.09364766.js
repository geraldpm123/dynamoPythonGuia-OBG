...
;// CONCATENATED MODULE: ./node_modules/mermaid/dist/sankeyDiagram-97764748.js
...
const findOrCreateNode = (ID) => {
  ID = mermaid_f47111a7.e.sanitizeText(ID, (0,mermaid_f47111a7.c)());
  if (!nodesMap[ID]) {
...
const db = {
  nodesMap,
  getConfig: () => (0,mermaid_f47111a7.c)().sankey,
  getNodes,
  getLinks,
  getGraph,
  addLink,
...
const draw = function(text, id, _version, diagObj) {
  const { securityLevel, sankey: conf } = (0,mermaid_f47111a7.c)();
  const defaultSankeyConfig = mermaid_f47111a7.K.sankey;
  let sandboxElement;
...
${prefix}${Math.round(value * 100) / 100}${suffix}`;
  ...
  (0,mermaid_f47111a7.o)(void 0, svg, 0, useMaxWidth);
};
const renderer = {
  draw
};
