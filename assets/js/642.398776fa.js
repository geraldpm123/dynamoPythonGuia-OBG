...
const tasks = [];
const rawTasks = [];
const getCommonDb = () => _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.L;
...
const draw = function(text, id, version, diagObj) {
  ...
  _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("timeline", diagObj.db);
  ...
  _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("task", tasks2);
  svgDraw.initGraphics(svg);
  const sections2 = diagObj.db.getSections();
  _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("sections", sections2);
  ...
  sections2.forEach(function(section) {
    ...
    _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("sectionHeight before draw", sectionHeight);
    maxSectionHeight = Math.max(maxSectionHeight, sectionHeight + 20);
  });
  let maxEventCount = 0;
  let maxEventLineLength = 0;
  _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("tasks.length", tasks2.length);
  for (const [i, task] of tasks2.entries()) {
    ...
    _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("taskHeight before draw", taskHeight);
  ...
  _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("maxSectionHeight before draw", maxSectionHeight);
  _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("maxTaskHeight before draw", maxTaskHeight);
  if (sections2 && sections2.length > 0) {
    sections2.forEach((section) => {
      ...
      _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("sectionNode", sectionNode);
      const sectionNodeWrapper = svg.append("g");
      const node = svgDraw.drawNode(sectionNodeWrapper, sectionNode, sectionNumber, conf);
      _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("sectionNode output", node);
  ...
  _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("bounds", box);
  if (title) {
  ...
  (0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.o)(
    void 0,
    svg,
...
const drawTasks = function(diagram2, tasks2, sectionColor, masterX, masterY, maxTaskHeight, conf, maxEventCount, maxEventLineLength, maxSectionHeight, isWithoutSections) {
  ...
  for (const task of tasks2) {
    ...
    _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("taskNode", taskNode);
    const taskWrapper = diagram2.append("g").attr("class", "taskWrapper");
    const node = svgDraw.drawNode(taskWrapper, taskNode, sectionColor, conf);
    const taskHeight = node.height;
    _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("taskHeight after draw", taskHeight);
...
const drawEvents = function(diagram2, events, sectionColor, masterX, masterY, conf) {
  ...
  for (const event of events) {
    ...
    _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("eventNode", eventNode);
