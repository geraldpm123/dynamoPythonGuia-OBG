...
const DEFAULT_PIE_CONFIG = _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.B.pie;
...
const addSection = (label, value) => {
  label = (0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.d)(label, (0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.c)());
  if (sections[label] === void 0) {
    sections[label] = value;
    _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(`added new section: ${label}, with value: ${value}`);
  }
};
...
const draw = (text, id, _version, diagObj) => {
  _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("rendering pie chart\n" + text);
  const db2 = diagObj.db;
  const globalConfig = (0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.c)();
  const pieConfig = (0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.C)(db2.getConfig(), globalConfig.pie);
  const MARGIN = 40;
  const LEGEND_RECT_SIZE = 18;
  const LEGEND_SPACING = 4;
  const height = 450;
  const pieWidth = height;
  const svg = (0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.A)(id);
  const group = svg.append("g");
  const sections2 = db2.getSections();
  group.attr("transform", "translate(" + pieWidth / 2 + "," + height / 2 + ")");
  const { themeVariables } = globalConfig;
  let [outerStrokeWidth] = (0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.D)(themeVariables.pieOuterStrokeWidth);
  ...
  (0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.i)(svg, height, totalWidth, pieConfig.useMaxWidth);
};
const renderer = { draw };
const diagram = {
  parser: parser$1,
