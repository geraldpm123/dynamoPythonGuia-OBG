...
const db = {
  getConfig: () => (0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.c)().journey,
  clear,
...
const drawText = function(elem, textData) {
  return (0,_svgDrawCommon_5ccd53ef_js__WEBPACK_IMPORTED_MODULE_5__.f)(elem, textData);
};
...
function drawActorLegend(diagram2) {
  const conf2 = (0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.c)().journey;
  let yPos = 60;
...
const conf = (0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.c)().journey;
...
const draw = function(text, id, version, diagObj) {
  ...
  (0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.i)(diagram2, height, width, conf2.useMaxWidth);
